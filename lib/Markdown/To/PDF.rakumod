...
sub read-batch($renderer, Text::Markdown::Document $md, PDF::Content::PageTree:D $pages, $frag, |c) is hidden-from-backtrace {
    my PDF::Tags::Tree::From::Pod $pod-reader .= new;
    my PDF::Tags::Render::Writer $writer = $renderer.writer: :$pages, :$frag;
    my Pair:D $pdf-ast = $pod-reader.render($md);
